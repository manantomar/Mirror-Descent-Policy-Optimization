...
def make_mujoco_env(env_id, seed, rank=0, allow_early_resets=True):
    """
...
def mujoco_arg_parser():
    ...
    #parser.add_argument('--seed', help='RNG seed, works as env seed', type=int, default=0)
    parser.add_argument('--run', help='which run, works as internal seed', type=int, default=0)
    parser.add_argument('--num_timesteps', type=float, default=int(2e6))
    parser.add_argument('--play', default=False, action='store_true')
    parser.add_argument('--kappa', default=1.0, type=float, help="Kappa value")
    parser.add_argument('--lam', default=1.0, type=float, help="lambda value")
    parser.add_argument('--vf_phi_update_interval', type=int, default=1)
    parser.add_argument('--sgd_steps', type=float, default=1)
    parser.add_argument('--klcoeff', default=1.0, type=float, help="kl coefficient")
    parser.add_argument('--tsallis_coeff', default=1.0, type=float, help="tsallis kl coefficient")
